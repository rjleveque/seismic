...
contains
    ...
    subroutine load_fault(fname)
        ...
        xcb(1) = center(1)
        xcb(2) = center(1)
        ycb(1) = center(2) - 0.5d0*total_width
        ycb(2) = center(2) + 0.5d0*total_width
        write(6,*) 'xcb: ',xcb(1),xcb(2)
        write(6,*) 'ycb: ',ycb(1),ycb(2)
        ...
        print *, "*********************"
        do i=1,nsubfaults
          ! should be equal for vertical fault:
