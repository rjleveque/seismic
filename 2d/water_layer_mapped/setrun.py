...
#------------------------------
    ...
    probdata.add_param('mu1',    0.00e8,  'mu in top layer (Pa)')
    ...
    for gaugeno,x in enumerate(np.linspace(-0.25,0.25,3)):
        gauges.append([gaugeno,x,1.-1./40e3,0,1e10])
        gauges.append([100+gaugeno,x,0.5,0,1e10])
        gauges.append([200+gaugeno,x,10./40e3,0,1e10])
